 ...
 *		 &lt;com.zkq.config-property&gt;
 *			 &lt;com.zkq.config-property-name&gt;ContextConfigLocation&lt;/com.zkq.config-property-name&gt;
 *			 &lt;com.zkq.config-property-type&gt;java.lang.String&lt;/com.zkq.config-property-type&gt;
 *			 &lt;com.zkq.config-property-value&gt;META-INF/applicationContext.xml&lt;/com.zkq.config-property-value&gt;
 *		 &lt;/com.zkq.config-property&gt;
 *	 &lt;/resourceadapter&gt;
 * &lt;/connector&gt;</pre>
 *
 * Note that "META-INF/applicationContext.xml" is the default context com.zkq.config
 * location, so it doesn't have to specified unless you intend to specify
 * different/additional com.zkq.config files. So in the default case, you may remove
 * the entire {@code com.zkq.config-property} section above.
 *
...
public class SpringContextResourceAdapter implements ResourceAdapter {
	 ...
	 * multiple context com.zkq.config paths in a single String value.
	 * @see #setContextConfigLocation
	 */
	 ...
	 * <p>This can be specified as "ContextConfigLocation" com.zkq.config
	...
	protected ConfigurableApplicationContext createApplicationContext(BootstrapContext bootstrapContext) {
		...
		// Extract individual com.zkq.config locations.
	 ...
	 * @param configLocations the parsed com.zkq.config locations
	 * @see #setContextConfigLocation
	 */
