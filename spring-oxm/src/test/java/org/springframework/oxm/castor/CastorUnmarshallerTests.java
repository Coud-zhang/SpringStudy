...
public class CastorUnmarshallerTests extends AbstractUnmarshallerTests<CastorMarshaller> {
	...
	/**
	 * Represents the xml with additional attribute that is not mapped in Castor com.zkq.config.
	 */
	...
	/**
	 * Represents the xml with additional element that is not mapped in Castor com.zkq.config.
	 */
