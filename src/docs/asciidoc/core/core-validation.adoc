...
[subs="verbatim,quotes"]
----
	<bean class="org.springframework.beans.factory.com.zkq.config.CustomEditorConfigurer">
...
[[core-convert-Spring-com.zkq.config]]
...
<<web.adoc#mvc-com.zkq.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.zkq.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
NOTE: If you use Spring MVC, remember to explicitly configure the conversion com.zkq.service that
...
For XML, you should use the `conversion-com.zkq.service` attribute of the
`mvc:annotation-driven` element.
See <<web.adoc#mvc-com.zkq.config-conversion, Conversion and Formatting>> for details.
...
See <<web.adoc#mvc-com.zkq.config-validation, Validation>> in the Spring MVC chapter.
