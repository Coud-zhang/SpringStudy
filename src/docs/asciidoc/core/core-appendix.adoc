...
{api-spring-framework}/beans/factory/com.zkq.config/FieldRetrievingFactoryBean.html[`FieldRetrievingFactoryBean`]
...
{api-spring-framework}/beans/factory/com.zkq.config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)[`staticField`]
property:
...
----
	...
	<bean id="testBean.age" class="org.springframework.beans.factory.com.zkq.config.PropertyPathFactoryBean"/>
----
====
...
----
	...
	<bean id="theAge"
			class="org.springframework.beans.factory.com.zkq.config.PropertyPathFactoryBean">
...
----
	...
	<bean id="jdbcConfiguration" class="org.springframework.beans.factory.com.zkq.config.PropertiesFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.zkq.config.ListFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.zkq.config.MapFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.zkq.config.SetFactoryBean">
...
==== Using `<annotation-com.zkq.config/>`
...
* <<core.adoc#beans-annotation-com.zkq.config, `@Autowired`/`@Inject`>> and `@Value`
...
This element is detailed in the section on <<core.adoc#beans-annotation-com.zkq.config,
...
Spring distribution, you should first read the appendix entitled <<xsd-com.zkq.config>>.
...
com.zkq.service object that (unknown to it) accesses a clustered
...
----
	...
	import org.springframework.beans.factory.com.zkq.config.BeanDefinitionHolder;
	import org.springframework.beans.factory.support.AbstractBeanDefinition;
	import org.springframework.beans.factory.support.BeanDefinitionBuilder;
