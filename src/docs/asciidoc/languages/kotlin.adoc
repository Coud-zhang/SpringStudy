...
https://docs.spring.io/spring-boot/docs/current/reference/html/boot-features-external-com.zkq.config.html#boot-features-external-com.zkq.config-typesafe-configuration-properties[`@ConfigurationProperties`]
