...
the meaty business logic of an application being contained in the domain and com.zkq.service
...
----
	...
	import org.springframework.showcase.fortune.com.zkq.service.FortuneService
