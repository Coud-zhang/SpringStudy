...
<<webflux-com.zkq.config, WebFlux infrastructure>> and <<webflux-httphandler, run it>> with a few
lines of code.
...
`WebHandler`. When using the <<webflux-com.zkq.config>>, registering a `WebFilter` is as simple
...
<<webflux-com.zkq.config>>, registering a `WebExceptionHandler` is as simple as declaring it as a
...
| Extension of `ResponseStatusExceptionHandler` that can also determine the HTTP status
  ...
  This handler is declared in the <<webflux-com.zkq.config>>.
...
<<webflux-com.zkq.config-message-codecs>>.
...
[[webflux-framework-com.zkq.config]]
=== WebFlux Config
[.small]#<<web.adoc#mvc-servlet-com.zkq.config, Same as in Spring MVC>>#
...
However, in most cases, the <<webflux-com.zkq.config>> is the best starting point. It declares the
required beans and provides a higher-level configuration callback API to customize it.

NOTE: Spring Boot relies on the WebFlux com.zkq.config to configure Spring WebFlux and also provides
...
`HandlerResultHandler` implementations, all of which are declared in the <<webflux-com.zkq.config>>:
...
to your Spring configuration. <<webflux-com.zkq.config-view-resolvers, WebFlux Config>> provides a
...
views through the <<webflux-com.zkq.config-view-resolvers, WebFlux Configuration>>. Default views are
...
You can also submit multipart requests from non-browser clients in a RESTful com.zkq.service
...
You can use the <<webflux-com.zkq.config-message-codecs>> option of the <<webflux-com.zkq.config>> to
...
<<webflux-com.zkq.config-conversion, WebFlux Java configuration>> to register `Converter` and
...
for optimal performance. See the section on configuring <<webflux-com.zkq.config-static-resources>>.




[[webflux-com.zkq.config]]
== WebFlux Config
[.small]#<<web.adoc#mvc-com.zkq.config, Same as in Spring MVC>>#
...
<<webflux-com.zkq.config-advanced-java>>.



[[webflux-com.zkq.config-enable]]
=== Enabling WebFlux Config
[.small]#<<web.adoc#mvc-com.zkq.config-enable, Same as in Spring MVC>>#

You can use the `@EnableWebFlux` annotation in your Java com.zkq.config, as the following example shows:
...
[[webflux-com.zkq.config-customize]]
=== WebFlux com.zkq.config API
[.small]#<<web.adoc#mvc-com.zkq.config-customize, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-conversion]]
=== Conversion, formatting
[.small]#<<web.adoc#mvc-com.zkq.config-conversion, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-validation]]
=== Validation
[.small]#<<web.adoc#mvc-com.zkq.config-validation, Same as in Spring MVC>>#
...
mark it with `@Primary` in order to avoid conflict with the one declared in the MVC com.zkq.config.



[[webflux-com.zkq.config-content-negotiation]]
=== Content Type Resolvers
[.small]#<<web.adoc#mvc-com.zkq.config-content-negotiation, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-message-codecs]]
=== HTTP message codecs
[.small]#<<web.adoc#mvc-com.zkq.config-message-converters, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-view-resolvers]]
=== View Resolvers
[.small]#<<web.adoc#mvc-com.zkq.config-view-resolvers, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-static-resources]]
=== Static Resources
[.small]#<<web.adoc#mvc-com.zkq.config-static-resources, Same as in Spring MVC>>#
...
[[webflux-com.zkq.config-path-matching]]
=== Path Matching
[.small]#<<web.adoc#mvc-com.zkq.config-path-matching, Same as in Spring MVC>>#

You can customize options related to path matching. For details on the individual options, see the
{api-spring-framework}/web/reactive/com.zkq.config/PathMatchConfigurer.html[`PathMatchConfigurer`] javadoc.
...
[.small]#<<web.adoc#mvc-com.zkq.config-advanced-java, Same as in Spring MVC>>#
