...
To enable CORS in the MVC Java com.zkq.config, you can use the `CorsRegistry` callback,
as the following example shows:
...
[subs="verbatim"]
----
CorsConfiguration com.zkq.config = new CorsConfiguration();

// Possibly...
// com.zkq.config.applyPermitDefaultValues()

com.zkq.config.setAllowCredentials(true);
com.zkq.config.addAllowedOrigin("https://domain1.com");
com.zkq.config.addAllowedHeader("*");
com.zkq.config.addAllowedMethod("*");

UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
source.registerCorsConfiguration("/**", com.zkq.config);
