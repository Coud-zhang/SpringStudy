...
(see <<mvc-container-com.zkq.config>>):
...
[[mvc-servlet-com.zkq.config]]
=== Web MVC Config
[.small]#<<web-reactive.adoc#webflux-framework-com.zkq.config, Same as in Spring WebFlux>>#
...
In most cases, the <<mvc-com.zkq.config>> is the best starting point. It declares the required
...
----
	public class MyWebAppInitializer extends AbstractDispatcherServletInitializer {
		...
		protected WebApplicationContext createServletApplicationContext() {
			...
			cxt.setConfigLocation("/WEB-INF/spring/dispatcher-com.zkq.config.xml");
			return cxt;
		}
...
See <<mvc-com.zkq.config-interceptors>> in the section on MVC configuration for examples of how to
...
The <<mvc-com.zkq.config>> automatically declares built-in resolvers for default Spring MVC
...
configuration. The <<mvc-com.zkq.config>> provides a dedicated configuration API for
<<mvc-com.zkq.config-view-resolvers>> and for adding logic-less
<<mvc-com.zkq.config-view-controller, View Controllers>> which are useful for HTML template
...
See <<mvc-com.zkq.config-view-resolvers>> under <<mvc-com.zkq.config>> for configuration details.
...
* In `web.xml`, add a `"<multipart-com.zkq.config>"` section to the servlet declaration.
...
See <<mvc-com.zkq.config-path-matching>> in the configuration section.
...
* `useSuffixPatternMatching(false)`, see <<mvc-com.zkq.config-path-matching, PathMatchConfigurer>>
* `favorPathExtension(false)`, see <<mvc-com.zkq.config-content-negotiation, ContentNegotiationConfigurer>>
...
`mediaTypes` property of <<mvc-com.zkq.config-content-negotiation,ContentNegotiationConfigurer>>.
...
See <<mvc-com.zkq.config-content-negotiation>>.
...
| Alternative to `DeferredResult`, as a convenience (for example, when an underlying com.zkq.service
...
<<mvc-com.zkq.config-path-matching>>. In the MVC XML namespace, you can set
...
Multipart requests can also be submitted from non-browser clients in a RESTful com.zkq.service
...
You can use the <<mvc-com.zkq.config-message-converters>> option of the <<mvc-com.zkq.config>> to
...
<<mvc-com.zkq.config-conversion,MVC com.zkq.config>> to register `Converter` and `Formatter`
...
for optimal performance. See the section on configuring <<mvc-com.zkq.config-static-resources>>.
...
[[mvc-com.zkq.config]]
== MVC Config
[.small]#<<web-reactive.adoc#webflux-com.zkq.config, Same as in Spring WebFlux>>#
...
see <<mvc-com.zkq.config-advanced-java>> and <<mvc-com.zkq.config-advanced-xml>>.
...
and <<mvc-servlet-com.zkq.config>>.



[[mvc-com.zkq.config-enable]]
=== Enable MVC Configuration
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-enable, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-customize]]
=== MVC Config API
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-customize, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-conversion]]
=== Type Conversion
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-conversion, Same as in Spring WebFlux>>#
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<mvc:annotation-driven conversion-com.zkq.service="conversionService"/>
...
[[mvc-com.zkq.config-validation]]
=== Validation
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-validation, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-interceptors]]
=== Interceptors
...
[[mvc-com.zkq.config-content-negotiation]]
=== Content Types
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-content-negotiation, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-message-converters]]
=== Message Converters
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-message-codecs, Same as in Spring WebFlux>>#

You can customize `HttpMessageConverter` in Java configuration by overriding
{api-spring-framework}/web/servlet/com.zkq.config/annotation/WebMvcConfigurer.html#configureMessageConverters-java.util.List-[`configureMessageConverters()`]
(to replace the default converters created by Spring MVC) or by overriding
{api-spring-framework}/web/servlet/com.zkq.config/annotation/WebMvcConfigurer.html#extendMessageConverters-java.util.List-[`extendMessageConverters()`]
...
[[mvc-com.zkq.config-view-controller]]
=== View Controllers
...
[[mvc-com.zkq.config-view-resolvers]]
=== View Resolvers
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-view-resolvers, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-static-resources]]
=== Static Resources
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-static-resources, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-path-matching]]
=== Path Matching
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-path-matching, Same as in Spring WebFlux>>#

You can customize options related to path matching and treatment of the URL.
For details on the individual options, see the
{api-spring-framework}/web/servlet/com.zkq.config/annotation/PathMatchConfigurer.html[`PathMatchConfigurer`] javadoc.
...
[[mvc-com.zkq.config-advanced-java]]
=== Advanced Java Config
[.small]#<<web-reactive.adoc#webflux-com.zkq.config-advanced-java, Same as in Spring WebFlux>>#
...
[[mvc-com.zkq.config-advanced-xml]]
=== Advanced XML Config
