...
interaction between the data access layer and the business or com.zkq.service layer.
...
This is primarily a com.zkq.service provider interface (SPI), although you can use it
...
[subs="verbatim,quotes"]
----
	// the com.zkq.service interface that we want to make transactional
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<!-- this is the com.zkq.service object that we want to make transactional -->
		<bean id="fooService" class="x.y.com.zkq.service.DefaultFooService"/>
		...
		<aop:com.zkq.config>
			<aop:pointcut id="fooServiceOperation" expression="execution(* x.y.com.zkq.service.FooService.*(..))"/>
...
Examine the preceding configuration. It assumes that you want to make a com.zkq.service object, the `fooService`
...
The `<aop:com.zkq.config/>` definition ensures that the transactional advice defined by the
...
A common requirement is to make an entire com.zkq.service layer transactional. The best way to
do this is to change the pointcut expression to match any operation in your
com.zkq.service layer. The following example shows how to do so:
...
----
	<aop:com.zkq.config>
		<aop:pointcut id="fooServiceMethods" expression="execution(* x.y.com.zkq.service.*.*(..))"/>
		<aop:advisor advice-ref="txAdvice" pointcut-ref="fooServiceMethods"/>
	</aop:com.zkq.config>
----
====

NOTE: In the preceding example, it is assumed that all your com.zkq.service interfaces are defined
in the `x.y.com.zkq.service` package. See <<core.adoc#aop, the AOP section>> for more details.
...
----
	...
	[JdkDynamicAopProxy] - Creating JDK dynamic proxy for [x.y.com.zkq.service.DefaultFooService]

	<!-- ... the insertFoo(..) method is now being invoked on the proxy -->
	[TransactionInterceptor] - Getting transaction for x.y.com.zkq.service.FooService.insertFoo

	<!-- the transactional advice kicks in here... -->
	[DataSourceTransactionManager] - Creating new transaction with name [x.y.com.zkq.service.FooService.insertFoo]
	[DataSourceTransactionManager] - Acquired Connection [org.apache.commons.dbcp.PoolableConnection@a53de4] for JDBC transaction

	<!-- the insertFoo(..) method from DefaultFooService throws an exception... -->
	[RuleBasedTransactionAttribute] - Applying rules to determine whether transaction should rollback on java.lang.UnsupportedOperationException
	[TransactionInterceptor] - Invoking rollback for transaction on x.y.com.zkq.service.FooService.insertFoo due to throwable [java.lang.UnsupportedOperationException]
	...
	Exception in thread "main" java.lang.UnsupportedOperationException at x.y.com.zkq.service.DefaultFooService.insertFoo(DefaultFooService.java:14)
...
classes, typically com.zkq.service layer classes, declaratively in your application. This
...
Consider the scenario where you have a number of com.zkq.service layer objects, and you want to
...
As a point of comparison, first assume that all of your com.zkq.service layer classes are
defined in a root `x.y.com.zkq.service` package. To make all beans that are instances of classes
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.zkq.config>
			...
			<aop:pointcut id="serviceOperation"
					expression="execution(* x.y.com.zkq.service..*Service.*(..))"/>
		...
		<bean id="fooService" class="x.y.com.zkq.service.DefaultFooService"/>
		<bean id="barService" class="x.y.com.zkq.service.extras.SimpleBarService"/>

		<!-- ... and these two beans won't -->
		<bean id="anotherService" class="org.xyz.SomeService"/> <!-- (not in the right package) -->
		<bean id="barManager" class="x.y.com.zkq.service.SimpleBarManager"/> <!-- (doesn't end in 'Service') -->
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.zkq.config>
			...
			<aop:pointcut id="noTxServiceOperation"
					expression="execution(* x.y.com.zkq.service.ddl.DefaultDdlManager.*(..))"/>
		...
		<bean id="anotherFooService" class="x.y.com.zkq.service.ddl.DefaultDdlManager"/>
...
[subs="verbatim,quotes"]
----
	// the com.zkq.service class that we want to make transactional
	@Transactional
	public class DefaultFooService implements FooService {
...
within the same thread (for example, a com.zkq.service facade that delegates to several repository methods
where all the underlying resources have to participate in the com.zkq.service-level transaction).
...
the first case the bean is given to the com.zkq.service directly; in the second case it is given
...
more business com.zkq.service dependencies on the data access or transaction strategy, no more
hard-coded resource lookups, no more hard-to-replace singletons, no more custom com.zkq.service
...
You can annotate the com.zkq.service layer with `@Transactional` annotations and instruct the
...
exist on the implementation of the surrounding business com.zkq.service. It needs only a Spring
...
a transaction manager and a business com.zkq.service definition in a Spring application context
...
sources are transactional container ones, a business com.zkq.service can demarcate transactions
...
consider using the Spring `context:annotation-com.zkq.config` XML element in your application
...
----
	<beans>
		...
		<!-- post-processors for all standard com.zkq.config annotations -->
...
[[oxm-schema-based-com.zkq.config]]
