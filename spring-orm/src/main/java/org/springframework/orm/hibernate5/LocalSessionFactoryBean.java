...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
	...
	/**
	 * Set the location of a single Hibernate XML com.zkq.config file, for example as
	...
	/**
	 * Set the locations of multiple Hibernate XML com.zkq.config files, for example as
	 ...
	 * Analogous to mapping entries in a Hibernate XML com.zkq.config file.
	 * Alternative to the more generic setMappingLocations method.
	 * <p>Can be used to add to mappings from a Hibernate XML com.zkq.config file,
	...
	/**
	 * Specify a Hibernate {@link MetadataSources} com.zkq.service to use (e.g. reusing an
