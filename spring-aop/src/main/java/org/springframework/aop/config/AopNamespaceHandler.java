 ...
 * {@code <aop:com.zkq.config>} tag. A {@code com.zkq.config} tag can include nested
...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	 ...
	 * '{@code com.zkq.config}', '{@code spring-configured}', '{@code aspectj-autoproxy}'
	 * and '{@code scoped-proxy}' tags.
	 */
	@Override
	public void init() {
		// In 2.0 XSD as well as in 2.1 XSD.
		registerBeanDefinitionParser("com.zkq.config", new ConfigBeanDefinitionParser());
