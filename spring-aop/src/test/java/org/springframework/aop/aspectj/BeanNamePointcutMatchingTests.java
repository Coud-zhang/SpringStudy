...
public class BeanNamePointcutMatchingTests {
	...
	public void testMatchingPointcuts() {
		...
		assertMatch("someName/*/**", "bean(someName/*)");
		// JMX-kind
		assertMatch("com.zkq.service:name=traceService", "bean(com.zkq.service:name=traceService)");
		assertMatch("com.zkq.service:name=traceService", "bean(com.zkq.service:name=*)");
		assertMatch("com.zkq.service:name=traceService", "bean(*:name=traceService)");
