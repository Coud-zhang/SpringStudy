...
public class RequestContextHolderTests {
	...
	public void requestScopedService() throws Exception {
		assertTrue("request-scoped com.zkq.service must be a CGLIB proxy", AopUtils.isCglibProxy(this.requestScopedService));
	...
	public void sessionScopedService() throws Exception {
		assertTrue("session-scoped com.zkq.service must be a CGLIB proxy", AopUtils.isCglibProxy(this.sessionScopedService));
