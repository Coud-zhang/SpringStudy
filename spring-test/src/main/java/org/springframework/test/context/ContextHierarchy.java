 ...
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/soap-ws-com.zkq.config.xml")
 * public class SoapWebServiceTests extends AbstractWebTests {}
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/rest-ws-com.zkq.config.xml")
 ...
 * three application contexts will be loaded: one for {@code "/app-com.zkq.config.xml"},
 * one for {@code "/user-com.zkq.config.xml"}, and one for <code>{"/user-com.zkq.config.xml",
 * "/order-com.zkq.config.xml"}</code>. As with the previous example, the application
 * context loaded from {@code "/app-com.zkq.config.xml"} will be set as the parent context
 * for the contexts loaded from {@code "/user-com.zkq.config.xml"} and <code>{"/user-com.zkq.config.xml",
 * "/order-com.zkq.config.xml"}</code>.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 *     &#064;ContextConfiguration(name = "parent", locations = "/app-com.zkq.config.xml"),
 *     &#064;ContextConfiguration(name = "child",  locations = "/user-com.zkq.config.xml")
 * })
 * public class BaseTests {}
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/order-com.zkq.config.xml")
 * )
 ...
 * only from {@code "/test-user-com.zkq.config.xml"} and will have its parent set to the
 * context loaded from {@code "/app-com.zkq.config.xml"}.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 ...
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/test-user-com.zkq.config.xml", inheritLocations = false)
 * )
 * public class ExtendedTests extends BaseTests {}</pre>
 *
