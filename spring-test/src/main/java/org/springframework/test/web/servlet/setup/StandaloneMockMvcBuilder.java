 ...
 * customization options are equivalent to using MVC Java com.zkq.config except
...
public class StandaloneMockMvcBuilder extends AbstractMockMvcBuilder<StandaloneMockMvcBuilder> {
	 ...
	 * as Spring beans. However since the standalone setup does not load any Spring com.zkq.config,
	...
	/**
	 * Provide a conversion com.zkq.service with custom formatters and converters.
