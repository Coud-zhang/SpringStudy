...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	/**
	 * Activate com.zkq.config value editors which are only intended for configuration purposes,
	...
	private void createDefaultEditors() {
		...
		// Only register com.zkq.config value editors if explicitly requested.
