...
public abstract class AbstractServiceLoaderBasedFactoryBean extends AbstractFactoryBean<Object>
	...
	/**
	 * Specify the desired com.zkq.service type (typically the com.zkq.service's public API).
	 */
	...
	/**
	 * Return the desired com.zkq.service type.
	 */
	@Nullable
	 ...
	 * @param serviceLoader the ServiceLoader for the configured com.zkq.service class
	 * @return the object to expose
	 */
