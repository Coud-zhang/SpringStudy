...
public class ComponentScanAnnotationIntegrationTests {
	...
	public void viaContextRegistration() {
		...
		assertThat("com.zkq.config class bean not found", ctx.containsBeanDefinition("componentScanAnnotatedConfig"), is(true));
	...
	public void viaContextRegistration_WithValueAttribute() {
		...
		ctx.getBean(TestBean.class);
		assertThat("com.zkq.config class bean not found", ctx.containsBeanDefinition("componentScanAnnotatedConfig_WithValueAttribute"), is(true));
		assertThat("@ComponentScan annotated @Configuration class registered directly against " +
				"AnnotationConfigApplicationContext did not trigger component scanning as expected",
				ctx.containsBean("fooServiceImpl"), is(true));
	}
	...
	public void viaContextRegistration_FromPackageOfConfigClass() {
		...
		assertThat("com.zkq.config class bean not found", ctx.containsBeanDefinition("componentScanAnnotatedConfigWithImplicitBasePackage"), is(true));
		assertThat("@ComponentScan annotated @Configuration class registered directly against " +
				"AnnotationConfigApplicationContext did not trigger component scanning as expected",
	...
	public void viaContextRegistration_WithComposedAnnotation() {
		...
		assertThat("com.zkq.config class bean not found",
