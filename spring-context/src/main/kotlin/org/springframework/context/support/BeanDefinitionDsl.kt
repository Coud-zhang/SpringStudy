...
import org.springframework.beans.factory.com.zkq.config.BeanDefinition
import org.springframework.beans.factory.com.zkq.config.BeanDefinitionCustomizer
...
open class BeanDefinitionDsl(private val init: BeanDefinitionDsl.() -> Unit,
	...
	enum class Scope {
		 ...
		 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition.SCOPE_SINGLETON
		 */
		SINGLETON,

		/**
		 * Scope constant for the standard singleton scope
		 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition.SCOPE_PROTOTYPE
		 */
		PROTOTYPE
	}
	...
	enum class Role {
		 ...
		 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition.ROLE_APPLICATION
		 */
		APPLICATION,
		 ...
		 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition.ROLE_SUPPORT
		 */
		SUPPORT,
		 ...
		 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition.ROLE_INFRASTRUCTURE
		 */
		INFRASTRUCTURE
	}
	 ...
	 * @see org.springframework.beans.factory.com.zkq.config.BeanDefinition
	 */
