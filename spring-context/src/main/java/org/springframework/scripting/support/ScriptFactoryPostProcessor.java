 ...
 * references and com.zkq.config values to inject into the scripted object itself.
 *
...
public class ScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
	...
	/**
	 * Create a com.zkq.config interface for the given bean definition, defining setter
	 ...
	 * @return the com.zkq.config interface
