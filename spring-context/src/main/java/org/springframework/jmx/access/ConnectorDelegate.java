...
class ConnectorDelegate {
	 ...
	 * to the specified JMX com.zkq.service, or to a local MBeanServer if no com.zkq.service URL specified.
	 * @param serviceUrl the JMX com.zkq.service URL to connect to (may be {@code null})
