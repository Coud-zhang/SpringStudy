 ...
 * com.zkq.service requests for those beans at runtime, for example:
 *
 * <pre class="code">
 * &#064;Configuration
 ...
 * <pre class="code">
 * &lt;beans&gt;
 *    &lt;context:annotation-com.zkq.config/&gt;
 *    &lt;bean class="com.acme.AppConfig"/&gt;
 * &lt;/beans&gt;
 * </pre>
 *
 * <p>In the example above, {@code <context:annotation-com.zkq.config/>} is required in order to
 ...
 * <pre class="code">
 * &#064;Configuration
 * &#064;ImportResource("classpath:/com/acme/database-com.zkq.config.xml")
 * public class AppConfig {
 *
