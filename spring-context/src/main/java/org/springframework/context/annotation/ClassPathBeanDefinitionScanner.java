...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	...
	/**
	 * Specify whether to register annotation com.zkq.config post-processors.
	...
	public int scan(String... basePackages) {
		...
		// Register annotation com.zkq.config processors, if necessary.
	 ...
	 * <p>This method does <i>not</i> register an annotation com.zkq.config processor
