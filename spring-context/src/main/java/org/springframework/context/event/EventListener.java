 ...
 * registered automatically when using Java com.zkq.config or manually via the
 * {@code <context:annotation-com.zkq.config/>} or {@code <context:component-scan/>}
 * element when using XML com.zkq.config.
 *
