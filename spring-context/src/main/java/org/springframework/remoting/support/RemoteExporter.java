...
/**
 * Abstract base class for classes that export a remote com.zkq.service.
 * Provides "com.zkq.service" and "serviceInterface" bean properties.
 *
 * <p>Note that the com.zkq.service interface being used will show some signs of
...
public abstract class RemoteExporter extends RemotingSupport {
	...
	/**
	 * Set the com.zkq.service to export.
	...
	/**
	 * Return the com.zkq.service to export.
	 */
	...
	/**
	 * Set the interface of the com.zkq.service to export.
	 * The interface must be suitable for the particular com.zkq.service and remoting strategy.
	 */
	...
	/**
	 * Return the interface of the com.zkq.service to export.
	 */
	...
	/**
	 * Check whether the com.zkq.service reference has been set.
	 * @see #setService
	 */
	protected void checkService() throws IllegalArgumentException {
		Assert.notNull(getService(), "Property 'com.zkq.service' is required");
	}

	/**
	 * Check whether a com.zkq.service reference has been set,
	 * and whether it matches the specified com.zkq.service.
	...
	protected void checkServiceInterface() throws IllegalArgumentException {
		...
		if (service instanceof String) {
			throw new IllegalArgumentException("Service [" + service + "] is a String " +
					"rather than an actual com.zkq.service reference: Have you accidentally specified " +
					"the com.zkq.service bean name as value instead of as reference?");
		}
		if (!serviceInterface.isInstance(service)) {
			throw new IllegalArgumentException("Service interface [" + serviceInterface.getName() +
					"] needs to be implemented by com.zkq.service [" + service + "] of class [" +
					service.getClass().getName() + "]");
		}
	}

	/**
	 * Get a proxy for the given com.zkq.service object, implementing the specified
	 * com.zkq.service interface.
