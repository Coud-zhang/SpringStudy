 ...
 * to automatically wrap a given plain Java com.zkq.service object with an
 ...
 * on all com.zkq.service methods. However, in and out parameters still have to be serializable.
 *
...
public abstract class RmiBasedExporter extends RemoteInvocationBasedExporter {
	...
	/**
	 * Determine the object to export: either the com.zkq.service object itself
	 * or a RmiInvocationWrapper in case of a non-RMI com.zkq.service object.
	...
	protected Remote getObjectToExport() {
		...
		if (getService() instanceof Remote &&
			...
			// conventional RMI com.zkq.service
			return (Remote) getService();
		}
		else {
			// RMI invoker
			if (logger.isDebugEnabled()) {
				logger.debug("RMI com.zkq.service [" + getService() + "] is an RMI invoker");
			}
