...
/**
 * Generic remote access exception. A com.zkq.service proxy for any remoting
 ...
 * natural Java business interface that the com.zkq.service exposes. A client object
 ...
 *
 * <p>Even when switching from a remote com.zkq.service proxy to a local implementation
 ...
 * against a remote com.zkq.service, for example in terms of repeated method calls that
 * cause unnecessary roundtrips etc. However, it doesn't have to be aware whether
 * it is <i>actually working</i> against a remote com.zkq.service or a local implementation,
