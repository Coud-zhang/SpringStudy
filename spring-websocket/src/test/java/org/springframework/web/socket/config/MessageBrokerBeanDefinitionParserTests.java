 ...
 * Also see test configuration files websocket-com.zkq.config-broker-*.xml.
 *
 * @author Brian Clozel
 * @author Artem Bilan
...
public class MessageBrokerBeanDefinitionParserTests {
	...
	public void simpleBroker() throws Exception {
		loadBeanDefinitions("websocket-com.zkq.config-broker-simple.xml");
	...
	public void stompBrokerRelay() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-relay.xml");
	...
	public void customChannels() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-customchannels.xml");
	...
	public void customChannelsWithDefaultExecutor() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-customchannels-default-executor.xml");
	...
	public void customArgumentAndReturnValueTypes() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-custom-argument-and-return-value-types.xml");
	...
	public void messageConverters() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-converters.xml");
	...
	public void messageConvertersDefaultsOff() {
		loadBeanDefinitions("websocket-com.zkq.config-broker-converters-defaults-off.xml");
