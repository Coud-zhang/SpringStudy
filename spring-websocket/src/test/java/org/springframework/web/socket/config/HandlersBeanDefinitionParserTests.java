 ...
 * See test configuration files websocket-com.zkq.config-handlers-*.xml.
 *
 * @author Brian Clozel
...
public class HandlersBeanDefinitionParserTests {
	...
	public void webSocketHandlers() {
		loadBeanDefinitions("websocket-com.zkq.config-handlers.xml");
	...
	public void webSocketHandlersAttributes() {
		loadBeanDefinitions("websocket-com.zkq.config-handlers-attributes.xml");
	...
	@SuppressWarnings("unchecked")
	public void sockJs() {
		loadBeanDefinitions("websocket-com.zkq.config-handlers-sockjs.xml");
	...
	public void sockJsAttributes() {
		loadBeanDefinitions("websocket-com.zkq.config-handlers-sockjs-attributes.xml");
