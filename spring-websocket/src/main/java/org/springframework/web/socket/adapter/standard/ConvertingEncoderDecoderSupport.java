...
public abstract class ConvertingEncoderDecoderSupport<T, M> {
	 ...
	 * to Spring's conversion com.zkq.service. See {@link ConvertingEncoderDecoderSupport} for details.
	 ...
	 * to Spring's conversion com.zkq.service. See {@link ConvertingEncoderDecoderSupport} for
	 * details.
	 * @param <T> the type that this Encoder can convert to
	 */
