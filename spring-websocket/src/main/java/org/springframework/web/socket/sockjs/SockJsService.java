 ...
 * can be used to invoke this com.zkq.service. The processing servlet, as well as all filters involved,
...
public interface SockJsService {
	 ...
	 * @param sockJsPath the remainder of the path within the SockJS com.zkq.service prefix
