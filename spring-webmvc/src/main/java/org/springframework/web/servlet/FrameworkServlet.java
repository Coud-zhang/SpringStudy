...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/** Explicit context com.zkq.config location. */
	@Nullable
	 ...
	 * to be used for building a default context com.zkq.config location.
	 */
	...
	/**
	 * Set the context com.zkq.config location explicitly, instead of relying on the default
	...
	/**
	 * Return the explicit context com.zkq.config location, if any.
	 */
	@Nullable
