 ...
 * regard to com.zkq.config location precedence, overriding and defaulting in programmatic
...
public class Spr8510Tests {
	...
	/**
	 * If context com.zkq.config locations have been specified neither against the application
