 ...
 *
 * <p>The com.zkq.config location defaults can be overridden via the "contextConfigLocation"
 ...
 *
 * <p>Note: In case of multiple com.zkq.config locations, later bean definitions will
...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	/** Default com.zkq.config location for the root context. */
	public static final String DEFAULT_CONFIG_LOCATION = "/WEB-INF/applicationContext.xml";

	/** Default prefix for building a com.zkq.config location for a namespace. */
	public static final String DEFAULT_CONFIG_LOCATION_PREFIX = "/WEB-INF/";

	/** Default suffix for building a com.zkq.config location for a namespace. */
