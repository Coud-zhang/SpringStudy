 ...
 *
 * <p>Configure this resolver in your {@code faces-com.zkq.config.xml} file as follows:
 *
 * <pre class="code">
 * &lt;application>
 *   ...
 ...
 * Spring-managed com.zkq.service layer beans, for example in property values of
 * JSF-managed beans:
 *
 * <pre class="code">
 * &lt;managed-bean>
