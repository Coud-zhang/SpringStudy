 ...
 * specific port of a JAX-WS com.zkq.service.
 *
...
public class JaxWsPortClientInterceptor extends LocalJaxWsServiceFactory
	...
	/**
	 * Set the interface of the com.zkq.service that this factory should create a proxy for.
	 */
	...
	/**
	 * Return the interface of the com.zkq.service that this factory should create a proxy for.
	 */
	@Nullable
	...
	/**
	 * Set whether to look up the JAX-WS com.zkq.service on startup.
	 * <p>Default is "true". Turn this flag off to allow for late start
	 * of the target server. In this case, the JAX-WS com.zkq.service will be
	 ...
	 * annotation level of the specified com.zkq.service interface).
	 * @param ann the WebService annotation found on the specified com.zkq.service interface
	 */
	 ...
	 * i.e. has already looked up the JAX-WS com.zkq.service and port.
	 */
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		if (AopUtils.isToStringMethod(invocation.getMethod())) {
			return "JAX-WS proxy for port [" + getPortName() + "] of com.zkq.service [" + getServiceName() + "]";
		}
		// Lazily prepare com.zkq.service and stub if necessary.
		synchronized (this.preparationMonitor) {
			if (!isPrepared()) {
				prepare();
			}
	...
	/**
	 * Perform a JAX-WS com.zkq.service invocation based on the given method invocation.
	...
	protected Object doInvoke(MethodInvocation invocation) throws Throwable {
		try {
			...
			throw new RemoteConnectFailureException(
					"Could not connect to remote com.zkq.service [" + getEndpointAddress() + "]", ex);
		}
		catch (WebServiceException ex) {
			throw new RemoteAccessException(
					"Could not access remote com.zkq.service at [" + getEndpointAddress() + "]", ex);
		}
	}

	/**
	 * Perform a JAX-WS com.zkq.service invocation on the given port stub.
	 * @param invocation the AOP method invocation
