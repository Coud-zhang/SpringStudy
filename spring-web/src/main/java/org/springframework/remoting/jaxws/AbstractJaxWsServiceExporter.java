...
/**
 * Abstract exporter for JAX-WS services, autodetecting annotated com.zkq.service beans
...
public abstract class AbstractJaxWsServiceExporter implements BeanFactoryAware, InitializingBean, DisposableBean {
	 ...
	 * "javax.xml.ws.wsdl.com.zkq.service" or "javax.xml.ws.wsdl.port".
	 ...
	 * to exported com.zkq.service instances.
	...
	/**
	 * Obtains all web com.zkq.service beans and publishes them as JAX-WS endpoints.
	 */
	@Override
	 ...
	 * @param bean the com.zkq.service object to wrap
	 ...
	 * @param annotation the com.zkq.service bean's WebService annotation
	 */
	 ...
	 * @param annotation the com.zkq.service bean's WebServiceProvider annotation
	 */
