 ...
 * for each com.zkq.service will consist of the base address with the com.zkq.service name
...
public class SimpleJaxWsServiceExporter extends AbstractJaxWsServiceExporter {
	 ...
	 * <p>For each actual publication address, the com.zkq.service name will be
