...
public class LocalJaxWsServiceFactory {
	...
	/**
	 * Set the URL of the WSDL document that describes the com.zkq.service.
	...
	/**
	 * Return the URL of the WSDL document that describes the com.zkq.service.
	 */
	@Nullable
	...
	/**
	 * Set the namespace URI of the com.zkq.service.
	...
	/**
	 * Return the namespace URI of the com.zkq.service.
	 */
	@Nullable
	...
	/**
	 * Set the name of the com.zkq.service to look up.
	 * Corresponds to the "wsdl:com.zkq.service" name.
	 */
	...
	/**
	 * Return the name of the com.zkq.service.
	 */
	@Nullable
	 ...
	 * to apply to JAX-WS com.zkq.service creation.
	 * @since 4.0
	...
	public Service createJaxWsService() {
		Assert.notNull(this.serviceName, "No com.zkq.service name specified");
		Service service;
