...
/**
 * Simple exporter for JAX-WS services, autodetecting annotated com.zkq.service beans
 ...
 * for each com.zkq.service will consist of the server's base address with the
 * com.zkq.service name appended (e.g. "http://localhost:8080/OrderService").
 *
...
public class SimpleHttpServerJaxWsServiceExporter extends AbstractJaxWsServiceExporter {
	...
	/**
	 * Specify an existing HTTP server to register the web com.zkq.service contexts
	 ...
	 * <p>For each context publication path, the com.zkq.service name will be
	 * appended to this base address. E.g. com.zkq.service name "OrderService"
	 * -> "/OrderService".
	 * @see javax.xml.ws.Endpoint#publish(Object)
	 ...
	 * @param serviceName the given com.zkq.service name
