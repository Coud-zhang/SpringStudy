...
public class HttpComponentsHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
	 ...
	 * to indicate that no custom request com.zkq.config should be set and the defaults of the
	 ...
	 * @param config the HTTP invoker configuration that specifies the target com.zkq.service
