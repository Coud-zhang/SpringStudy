...
/**
 * {@link FactoryBean} for HTTP invoker proxies. Exposes the proxied com.zkq.service
 * for use as a bean reference, using the specified com.zkq.service interface.
 *
 * <p>The com.zkq.service URL must be an HTTP URL exposing an HTTP invoker com.zkq.service.
