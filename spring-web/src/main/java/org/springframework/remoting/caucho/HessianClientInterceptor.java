...
/**
 * {@link org.aopalliance.intercept.MethodInterceptor} for accessing a Hessian com.zkq.service.
 * Supports authentication via username and password.
 * The com.zkq.service URL must be an HTTP URL exposing a Hessian com.zkq.service.
 *
...
public class HessianClientInterceptor extends UrlBasedRemoteAccessor implements MethodInterceptor {
	...
	/**
	 * Set the username that this factory should use to access the remote com.zkq.service.
	 * Default is none.
	...
	/**
	 * Set the password that this factory should use to access the remote com.zkq.service.
	 * Default is none.
	...
	/**
	 * Set the timeout to use when waiting for a reply from the Hessian com.zkq.service.
	 ...
	 * @throws RemoteLookupFailureException if the com.zkq.service URL is invalid
	 */
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		try {
			...
			throw new RemoteProxyFailureException(
					"Failed to invoke Hessian proxy for remote com.zkq.service [" + getServiceUrl() + "]", ex);
		}
		finally {
	...
	protected RemoteAccessException convertHessianAccessException(Throwable ex) {
		if (ex instanceof HessianConnectionException || ex instanceof ConnectException) {
			return new RemoteConnectFailureException(
					"Cannot connect to Hessian remote com.zkq.service at [" + getServiceUrl() + "]", ex);
		}
		else {
			return new RemoteAccessException(
				"Cannot access Hessian remote com.zkq.service at [" + getServiceUrl() + "]", ex);
		}
	}
