...
public class HttpComponentsClientHttpRequestFactory implements ClientHttpRequestFactory, DisposableBean {
	 ...
	 * Can return {@code null} to indicate that no custom request com.zkq.config should
	 ...
	 * @param clientConfig the com.zkq.config held by the current
	 * @return the merged request com.zkq.config
	 * @since 4.2
	 */
