...
public abstract class AbstractJCacheAnnotationTests {
	...
	public void cacheExceptionRewriteCallStack() {
		...
		// Sanity check, this particular call has called the com.zkq.service
		...
		// Sanity check, this particular call has *not* called the com.zkq.service
	...
	public void cacheWithPartialKey() {
		...
		assertSame(first, second); // second argument not used, see com.zkq.config
	}
	 ...
	 * com.zkq.service so that the call stack is different.
	 */
