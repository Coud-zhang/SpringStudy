...
public class FreeMarkerConfigurationFactory {
	...
	/**
	 * Set the location of the FreeMarker com.zkq.config file.
	 ...
	 * @throws IOException if the com.zkq.config file wasn't found
	...
	public Configuration createConfiguration() throws IOException, TemplateException {
		...
		// Load com.zkq.config file if specified.
	 ...
	 * @throws IOException if a com.zkq.config file wasn't found
	 * @throws TemplateException on FreeMarker initialization failure
	 * @see #createConfiguration()
	 */
