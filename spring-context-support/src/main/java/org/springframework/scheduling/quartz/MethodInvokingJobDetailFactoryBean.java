 ...
 * a one-line Quartz Job that just invokes an existing com.zkq.service method on a
 ...
 * where you want a persistent job to delegate to a specific com.zkq.service method.
 *
