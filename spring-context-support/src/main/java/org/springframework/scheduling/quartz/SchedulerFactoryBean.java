...
public class SchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>,
	...
	/**
	 * Set the location of the Quartz properties com.zkq.config file, for example
	 ...
	 * <p>Can be used to override values in a Quartz properties com.zkq.config file,
	...
	private void initSchedulerFactory(StdSchedulerFactory schedulerFactory) throws SchedulerException, IOException {
		...
		if (this.configLocation != null) {
			if (logger.isDebugEnabled()) {
				logger.debug("Loading Quartz com.zkq.config from [" + this.configLocation + "]");
			}
